        ...
        <GlassCard className="p-8 bg-gradient-to-br from-purple-500/20 to-pink-500/20">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="text-center">
              <p className="text-white/60 mb-2">Lương cơ bản (hàng tháng)</p>
            ...
            <div className="text-center">
              <p className="text-white/60 mb-2">Tổng thu nhập (hàng tháng)</p>
              <div className="space-y-2">
          ...
          <div className="mt-8">
            <div className="flex items-center justify-between mb-2">
              <span className="text-white/60">Độ tin cậy</span>
              <span className="text-white font-semibold">{estimate.baseSalary.confidence}%</span>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="bg-white/5 border-white/10">
              <CardContent className="p-4 text-center">
                <p className="text-white/60 text-sm mb-2">Phân vị</p>
            ...
            <Card className="bg-white/5 border-white/10">
              <CardContent className="p-4 text-center">
                <p className="text-white/60 text-sm mb-2">So sánh</p>
            ...
            <Card className="bg-white/5 border-white/10">
              <CardContent className="p-4 text-center">
                <p className="text-white/60 text-sm mb-2">Xếp hạng</p>
      ...
      <motion.div variants={itemVariants}>
        <GlassCard className="p-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h4 className="text-white font-medium mb-3">Kỹ năng high-demand</h4>
              <div className="space-y-2">
                {estimate.skills.highDemand.length > 0 ? (
                  ...
                  <p className="text-white/60 text-sm">Không có kỹ năng high-demand</p>
                )}
              </div>
            </div>
            <div>
              <h4 className="text-white font-medium mb-3">Cần cải thiện</h4>
              <div className="space-y-3">
                {estimate.skills.improvement.length > 0 ? (
                  ...
                  <p className="text-white/60 text-sm">Tuyệt vời! Không có đề xuất cải thiện</p>
                )}
              </div>
            </div>
          </div>
          ...
          <Card className="bg-white/5 border-white/10">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="text-white font-semibold text-lg">{estimate.careerPath.nextRole}</h4>
                  <p className="text-white/60">Thời gian dự kiến: {estimate.careerPath.timeframe}</p>
                </div>
                <div className="text-right">
                  <p className="text-green-400 font-semibold">
                    +{estimate.careerPath.salaryIncrease}%
                  </p>
                  <p className="text-white/60 text-sm">tăng lương</p>
                </div>
              </div>
            </CardContent>
          </Card>
